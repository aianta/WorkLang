...
import org.worklang.execution.CompoundTransitionProcessor;
...
public class REST extends AbstractVerticle implements ExecutionApi{
	...
	public REST(Neo4JGraph graph) {
		this.graph = graph;
	}
	
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#start(io.vertx.core.Future)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#getRouter()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#info(io.vertx.ext.web.RoutingContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#infoJson()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#routeExists(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#addCompoundTransitionProcessor(java.lang.String, org.worklang.work.Instance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#addProxyRoute(java.lang.String, org.worklang.work.Instance)
	 */
	@Override
			...
			Route route = router.route(HttpMethod.POST,routePath).handler(rc->{
				...
				for (String s: inputInstancesToFetch) {
					...
					if (i.getCollection() != null) {
						inputsToSend.add(RESTUtils.collectionInstanceToJsonArray(i));
					}
					
					if (i.getState() != null) {
						inputsToSend.add(RESTUtils.stateInstanceToJson(i));
					}
	...
	/* (non-Javadoc)
	 * @see org.worklang.execution.impl.ExecutionApi#clear()
	 */
	@Override
	public void clear() {
		transitions.clear();
