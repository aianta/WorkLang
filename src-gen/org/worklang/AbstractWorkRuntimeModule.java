...
import org.worklang.parser.antlr.WorkAntlrTokenFileProvider;
import org.worklang.parser.antlr.WorkParser;
import org.worklang.parser.antlr.internal.InternalWorkLexer;
import org.worklang.scoping.WorkScopeProvider;
import org.worklang.serializer.WorkSemanticSequencer;
import org.worklang.serializer.WorkSyntacticSequencer;
import org.worklang.services.WorkGrammarAccess;
import org.worklang.validation.WorkConfigurableIssueCodesProvider;
import org.worklang.validation.WorkValidator;
...
public abstract class AbstractWorkRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/worklang/Work.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.worklang.Work");
	}
