...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Transition ID</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TransitionIDImpl extends TransitionalExpressionImpl implements TransitionID
{
   ...
   * @generated
   */
  public TransitionID getValue()
  {
    if (value != null && value.eIsProxy())
    {
      InternalEObject oldValue = (InternalEObject)value;
      value = (TransitionID)eResolveProxy(oldValue);
      if (value != oldValue)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, WorkPackage.TRANSITION_ID__VALUE, oldValue, value));
      }
    }
    return value;
  }
   ...
   * @generated
   */
  public TransitionID basicGetValue()
  {
    return value;
  }
   ...
   * @generated
   */
  public void setValue(TransitionID newValue)
  {
    TransitionID oldValue = value;
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WorkPackage.TRANSITION_ID__VALUE, oldValue, value));
  }
